...
- Для создания HTML-страниц, отчётов, CSV, JSON и других файлов: сгенерируй содержимое и сохрани через saveFile. После сохранения файла ты можешь открыть его в браузере через browserAgent с URL file:///полный/путь/к/файлу (полный путь вернёт saveFile).
